          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-3 text-primary-foreground text-lg font-medium hover:opacity-90 transition"
              >
                Get Started
